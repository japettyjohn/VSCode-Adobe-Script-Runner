const hostApps = [
	{
		...
		'darwin': `osascript -e 'tell application id "com.adobe.aftereffects" to DoScriptFile "{scriptFile}"'`,
		'win32': `"{appExe}" -r {scriptFile}`,
		'winExeKey' : 'winAfterFxExe',
	},
	{
		'shortName' : 'ai',
		'appName': 'Adobe Illustrator',
		'darwin': `osascript -e 'tell application id "com.adobe.illustrator" to do javascript file "{scriptFile}"'`,
		'win32': `"{appExe}" -r {scriptFile}`,
		'winExeKey' : 'winIllustratorExe',
	},
	{
		'shortName' : 'estk',
		...
		'winExeKey' : 'winEstkExe',
	},
	{
		'shortName' : 'ic',
		'appName': 'Adobe InCopy',
		'darwin': `osascript -e 'tell application id "com.adobe.InCopy" to do script "{scriptFile}" language javascript'`,
	...
	},
	{
		...
		'darwin': `osascript -e 'tell application id "com.adobe.InDesign" to do script "{scriptFile}" language javascript'`,
	...
	},
	{
		...
		'darwin': `osascript -e 'tell application id "com.adobe.photoshop" to do javascript file "{scriptFile}"'`,
		'win32': `"{appExe}" -r {scriptFile}`,
		'winExeKey' : 'winPhotoshopExe',
	},
];
